...
import eu.stratosphere.pact.runtime.sort.IndexedSortable;
...
* @author Stephan Ewen
*/
public final class RawNormalizedKeySorter<T> implements IndexedSortable
{
	...
	private final TypeAccessorsV2<T> accessors;
	...
	public RawNormalizedKeySorter(TypeAccessorsV2<T> accessors, List<MemorySegment> memory)
	{
		this(accessors, memory, DEFAULT_MAX_NORMALIZED_KEY_LEN);
	}
	
	public RawNormalizedKeySorter(TypeAccessorsV2<T> accessors, List<MemorySegment> memory, int maxNormalizedKeyBytes)
	{
