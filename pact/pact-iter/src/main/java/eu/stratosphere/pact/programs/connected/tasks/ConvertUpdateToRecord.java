...
import eu.stratosphere.pact.iterative.nephele.tasks.SortingReduce.PactRecordIntHashAccessor;
...
public class ConvertUpdateToRecord extends AbstractIterativeTask {
	...
	protected void initTask() {
		outputAccessors[0] = new PactRecordIntHashAccessor(new int[] {}, 
				new Class[] {});
	}
	...
	public final class PactRecordIntHashAccessor implements TypeAccessorsV2<PactRecord>
	{
		 ...
		 * @param keyFields
		 */
		public PactRecordIntHashAccessor(int[] keyFields, Class<? extends Key>[] keyTypes)
		{
		 ...
		 */
		private PactRecordIntHashAccessor(int[] keyFields, Key[] keys, int[] normalKeyLengths,
		...
		public int hash(PactRecord object)
		{
			int i = 0;
			try {
				long vid = object.getField(0, number).getValue();
		...
		public TypeAccessorsV2<PactRecord> duplicate() {
			return new PactRecordIntHashAccessor(this.keyFields, this.keyHolders, this.normalizedKeyLengths,
