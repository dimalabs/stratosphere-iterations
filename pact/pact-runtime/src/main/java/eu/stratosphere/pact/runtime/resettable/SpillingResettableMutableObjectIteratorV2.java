 ...
 * @param <T>
 */
public class SpillingResettableMutableObjectIteratorV2<T extends Value> implements ResettableMutableObjectIterator<T>, LastRepeatableMutableObjectIterator<T> {

	private static final Log LOG = LogFactory.getLog(SpillingResettableMutableObjectIteratorV2.class);
	...
	protected final TypeAccessorsV2<T> accessor;
	 ...
	 */
	public SpillingResettableMutableObjectIteratorV2(MemoryManager memoryManager, IOManager ioManager,
			MutableObjectIterator<T> input, TypeAccessorsV2<T> accessor, long availableMemory, 
	...
	public void open() throws IOException
	{
		...
		T nextRecord = accessor.createInstance();
	...
	@Override
	public boolean repeatLast(T target) {
