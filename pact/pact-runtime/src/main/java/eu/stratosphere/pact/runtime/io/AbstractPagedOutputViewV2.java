 ...
 * @author Stephan Ewen
 */
public abstract class AbstractPagedOutputViewV2 implements DataOutputViewV2
{
	 ...
	 */
	protected AbstractPagedOutputViewV2(final MemorySegment initialSegment,
			final int segmentSize, final int headerLength)
	{
	 ...
	 * @param headerLength The number of bytes to skip at the beginning of each segment for the header.
	 */
	protected AbstractPagedOutputViewV2(final int segmentSize, final int headerLength)
	{
		this.segmentSize = segmentSize;
		this.headerLength = headerLength;
	}
