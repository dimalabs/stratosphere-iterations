 ...
 */
public final class PactRecordAccessorsV2 implements TypeAccessorsV2<PactRecord>
{
	 ...
	 * @param keyFields
	 */
	public PactRecordAccessorsV2(int[] keyFields, Class<? extends Key>[] keyTypes)
	{
	 ...
	 */
	private PactRecordAccessorsV2(int[] keyFields, Key[] keys, int[] normalKeyLengths,
	...
	public TypeAccessorsV2<PactRecord> duplicate() {
		return new PactRecordAccessorsV2(this.keyFields, this.keyHolders, this.normalizedKeyLengths,
