...
public class DataOutputCollectorImpl<T extends Record> implements DataOutputCollector<T> {
  ...
  public DataOutputCollectorImpl(DataOutputView outputView, TypeSerializer<T> typeSerializer,
